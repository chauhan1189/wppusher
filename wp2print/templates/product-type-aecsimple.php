...
if ($product_type_matrix_types) { ?>
	<div class="print-products-area product-attributes" style="margin:0 0 15px 0;">
		...
		<div class="product-add-button" style="margin:0px;padding:0px;">
			<?php if ($is_modify) { ?>
				...
				<input type="hidden" name="product_type" value="aecsimple" class="product-type">
	...
	inc_coverage_prices['<?php echo $mid; ?>'] = <?php echo (float)$pprice; ?>;
		<?php } ?>
	<?php } ?>
	...
	function aec_get_coverage_price(aec_material, pnum) {
		return parseFloat(inc_coverage_prices[aec_material]);
	}
	...
	<?php if (!$is_modify) { include('product-upload-artwork-aecsimple.php'); } ?>
